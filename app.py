...
if is_ready:
    ...
    with col_table:
        ...
        if not df_filtered.empty:
            ...
            sum_total = raw_leaderboard['Total_Leads'].sum()
            sum_app = raw_leaderboard['Approved'].sum()
            sum_rej = raw_leaderboard['Rejected'].sum()
            sum_pen = raw_leaderboard['Pending'].sum()
            
            pct_app = (sum_app / sum_total * 100) if sum_total > 0 else 0.0
